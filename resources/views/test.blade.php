...
<head>
    ...
    <title>Innova Tech Bangladesh</title>
                    ...
                    <div class="row footer-widget-wrapper">
                        <div class="col-lg-4 col-md-4 col-sm-6 footer-widget">
                            ...
                            <ul class="footer-widget__list">
                                ...
                                <li><a href="mailto:innovatech.frm@gmail.com" class="hover-style-link">innovatech.frm@gmail.com</a></li>
                                <li><a href="" class="hover-style-link text-black font-weight--bold">(+88)01737988070</a></li>
                                <li><a href="https://innovabd.tech/" class="hover-style-link text-color-primary">innovabd.tech</a></li>
                            </ul>
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-6 footer-widget">
                            ...
                            <ul class="footer-widget__list">
                                ...
                                <li><a href="#" class="hover-style-link">Services</a></li>
                                <li><a href="#" class="hover-style-link">Softwares</a></li>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-6 text-center text-md-left">
                            <span class="copyright-text">&copy; 2020 InnovaTech. <a href="https://innovabd.tech/">All Rights Reserved.</a></span>
                        </div>
